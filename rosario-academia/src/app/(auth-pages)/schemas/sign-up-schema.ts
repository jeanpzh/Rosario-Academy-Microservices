...
export const stepOne = object({
  firstName: z.string().min(1, { message: 'El nombre es requerido!' }),
  paternalLastName: z
    .string()
    .min(1, { message: 'Apellido paterno requerido' }),
  maternalLastName: z
    .string()
    .min(1, { message: 'Apellido materno requerido' }),
  birthdate: z
    .string()
  ...
  email: z
    ...
    .refine(
      ...
      {
        message:
          'Solo se permiten los dominios @gmail.com, @hotmail.com, @outlook.com'
      }
    ),
  phone: z
    .string()
