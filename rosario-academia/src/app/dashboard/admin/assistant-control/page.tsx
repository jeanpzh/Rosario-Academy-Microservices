...
import { useFetchAssistants } from '@/hooks/use-fetch-assistants'
...
export default function AssistantControlPage() {
  ...
  const setCurrentItem = useAssistantStore((state) => state.setCurrentItem)
  const { setOpenModal } = useModalStore()
  // Fetch Assistants
  const { data: assistants = [], isLoading } = useFetchAssistants()
